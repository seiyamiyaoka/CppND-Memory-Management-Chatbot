...
{
    std::cout << "ChatBot Copy Constructor(deep copy)" << std::endl;
...
{
    std::cout << "move ChatBot" << std::endl;
...
{
    std::cout << "ASSIGNING chatbotinstance" << std::endl;
...
// https://qiita.com/false-git@github/items/79bf1b6acc00dc43d173
// サイズが必要なものはcppに配置する
